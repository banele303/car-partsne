...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 bg-white">
      ...
      <div className="container mx-auto px-6 relative z-40 mt-10">
        <div className="bg-white/95 backdrop-blur-2xl border border-slate-200 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] rounded-[32px] p-8 flex flex-wrap items-center justify-between gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 flex-grow w-full md:w-auto">
             <div className="relative flex-grow w-full md:max-w-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Search wheels, tyres, specific parts..." 
             ...
             <div className="w-full md:w-auto">
               <Select value={selectedMake} onValueChange={setSelectedMake}>
                 ...
                 <SelectContent className="rounded-2xl border-slate-200 shadow-2xl p-2">
                   <SelectItem value="all" className="font-bold text-sm rounded-xl mb-1 cursor-pointer uppercase">All Categories</SelectItem>
                   {makes?.map((make) => (
            ...
            {isLoading ? (
              ...
              >
                <div className="flex flex-col items-center gap-6 text-center">
                  <div className="w-20 h-20 border-4 border-primary border-t-transparent rounded-full animate-spin shadow-[0_0_20px_rgba(239,68,68,0.2)]" />
                  <div>
                    <p className="text-xl font-black uppercase tracking-[0.2em] text-slate-900 mb-2">Scanning Warehouse...</p>
                    {connError && (
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="p-6 bg-slate-50 border border-slate-200 rounded-3xl mt-4"
                      >
                        <p className="text-sm text-slate-500 font-medium italic">
                          Connection taking longer than usual. <br />
                          Please ensure <code className="bg-slate-200 px-2 py-0.5 rounded text-primary">npx convex dev</code> is running.
                        </p>
                      </motion.div>
                    )}
                  </div>
              ...
              >
                ...
                <p className="text-slate-500 font-medium mb-12 italic text-lg max-w-md mx-auto">We haven&apos;t digitized this specific part yet. Contact our desk for a manual stock check across our Woodstock facility.</p>
        ...
        <div className="container mx-auto px-6 text-center">
           <div className="max-w-5xl mx-auto mb-24">
             ...
             <h2 className="text-5xl lg:text-[70px] font-black tracking-tighter leading-none text-slate-900 mb-8 italic">
               THE <span className="gradient-text uppercase not-italic">WHEELWORX GUARANTEE.</span>
             </h2>
             <p className="text-2xl text-slate-500 font-medium leading-relaxed italic max-w-3xl mx-auto">Every component in our Woodstock facility undergoes technical inspection before dispatch to ensure workshop-ready performance.</p>
           </div>
           ...
           <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                { icon: MapPin, title: "Woodstock Hub", desc: "Visit our Sir Lowry Road facility for direct collections." },
