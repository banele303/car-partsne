...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsSubmitted(true);
      toast.success("Service request received! Our team will contact you shortly.");
      ...
      <section className="relative pt-48 pb-32 overflow-hidden bg-[#F8F9FB]">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              <Phone className="h-3.5 w-3.5 text-primary" /> Reach the Woodstock Workshop
            </motion.span>
            ...
            >
              Cape Town&apos;s most responsive <span className="text-slate-900 not-italic font-bold">wheel specialists</span>. Message us for rim repairs, tyre stock, or custom mag painting quotes.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              <div className="bg-slate-50 p-12 rounded-[50px] border border-slate-100 shadow-xl shadow-black/5">
                <h3 className="text-3xl font-black uppercase tracking-tight text-slate-900 mb-8 leading-none">THE WORKSHOP <br /><span className="text-primary italic">EXPERIENCE.</span></h3>
                <div className="space-y-8">
                   <div className="flex gap-6 items-start">
                      ...
                      <div>
                         <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Woodstock HQ</p>
                         <p className="text-xl font-bold text-slate-900 italic leading-tight">80 Sir Lowry Road<br />Cape Town, 8001</p>
                      </div>
                   </div>
                   <div className="flex gap-6 items-start">
                      <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                      ...
                      <div>
                         ...
                         <p className="text-xl font-bold text-slate-900 italic leading-tight text-sm">Mon - Fri: 08:30 - 17:30</p>
                         <p className="text-xl font-bold text-slate-900 italic leading-tight text-sm">Sat: 09:00 - 14:00</p>
                      </div>
                   </div>
                </div>
              </div>
              ...
              <div className="grid gap-6">
                <Link href="tel:+27763526616" className="group p-8 bg-white border border-slate-100 rounded-[32px] flex items-center gap-8 hover:shadow-2xl transition-all">
                   ...
                   <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Direct Service Desk</p>
                      <h4 className="text-2xl font-black text-slate-900 italic">076 352 6616</h4>
                   </div>
                </Link>
                <Link href="mailto:info@wheelworx.co.za" className="group p-8 bg-white border border-slate-100 rounded-[32px] flex items-center gap-8 hover:shadow-2xl transition-all">
                   <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-primary transition-colors">
                   ...
                   <div>
                      ...
                      <h4 className="text-2xl font-black text-slate-900 italic">info@wheelworx.co.za</h4>
                   </div>
                </Link>
              </div>
            </motion.div>
                ...
                <AnimatePresence mode="wait">
                   {isSubmitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-4xl font-black text-white uppercase tracking-tight mb-6">Service Request <br /><span className="text-primary italic">Logged.</span></h3>
                      <p className="text-xl text-slate-400 font-medium italic mb-12">Our wheel specialists will contact you shortly to confirm your booking or provide a quote.</p>
                    ...
                    <motion.div key="form" className="relative z-10">
                      <h3 className="text-4xl font-black text-white uppercase tracking-tight mb-12 leading-none">BOOK A <br /><span className="text-primary italic">SERVICE.</span></h3>
                      <form onSubmit={handleSubmit} className="space-y-8">
                         ...
                         <div className="space-y-3">
                            ...
                            <input 
                              type="email" 
                              required
                              placeholder="e.g. info@wheelworx.co.za"
                              className="w-full h-18 px-8 bg-white/5 border border-white/10 rounded-3xl text-white font-bold focus:ring-4 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-white/10"
                         ...
                         <div className="space-y-3">
                            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 ml-4">Service Required (Rim Repair, Tyres, etc.)</label>
                            <textarea 
                              required
                              rows={5}
                         ...
                         >
                           {isSubmitting ? "TRANSMITTING..." : "BOOK APPOINTMENT"}
                        </Button>
                      </form>
                    </motion.div>
                  )}
        ...
        <div className="container mx-auto px-6">
           <div className="grid lg:grid-cols-2 gap-24 items-center">
              <div>
                 ...
                 <h2 className="text-5xl lg:text-7xl font-black tracking-tighter leading-none text-slate-900 mb-10">THE HEART OF <br /><span className="gradient-text uppercase italic">WOODSTOCK WHEELS.</span></h2>
                 <p className="text-xl text-slate-500 font-medium italic mb-12">Strategically positioned on Sir Lowry Road for rapid access from the CBD and surrounding suburbs.</p>
                 <div className="space-y-6">
                    <div className="flex items-center gap-4 text-slate-900 font-black uppercase tracking-widest text-[11px]">
                       <Truck className="h-5 w-5 text-primary" /> Rapid Turnaround Times
                    </div>
                     <div className="flex items-center gap-4 text-slate-900 font-black uppercase tracking-widest text-[11px]">
                        <MapPin className="h-5 w-5 text-primary" /> Woodstock HQ
                     </div>
                    <div className="flex items-center gap-4 text-slate-900 font-black uppercase tracking-widest text-[11px]">
                       <ShieldCheck className="h-5 w-5 text-primary" /> Secure Workshop Facility
                    </div>
                 </div>
              </div>
              <div className="relative rounded-[60px] overflow-hidden border-[12px] border-white shadow-2xl shadow-black/10 h-[500px]">
                  <iframe
                     src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3310.875225333583!2d18.43126831521124!3d-33.92989698064111!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1dcc5d9472626e33%3A0x7770e704e54457e!2s80%20Sir%20Lowry%20Rd%2C%20Woodstock%2C%20Cape%20Town%2C%207925!5e0!3m2!1sen!2sza!4v1709979000000!5m2!1sen!2sza"
                     width="100%"
                     height="100%"
                     style={{ border: 0 }}
                     allowFullScreen
