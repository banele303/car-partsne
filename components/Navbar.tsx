        ...
        <div className="flex items-center justify-between gap-12">
          ...
          <Link href="/" className="flex items-center shrink-0 group">
             <div className="flex flex-col leading-none">
                <span className="text-3xl font-black tracking-tighter text-slate-900 group-hover:text-primary transition-colors">COMMERCIAL</span>
          ...
          <div className="flex items-center gap-6 shrink-0 ml-auto xl:ml-0">
            ...
            <div className="hidden sm:flex flex-col items-end leading-none mr-2">
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Call HQ</span>
                <span className="text-xs font-bold text-slate-900">011 493 7010</span>
            </div>
            ...
            >
              ...
              <div className="hidden sm:flex flex-col items-start leading-none">
                <span className="text-[10px] font-black uppercase tracking-widest opacity-70 mb-0.5">WhatsApp</span>
                <span className="text-xs font-bold font-mono">079 179 9149</span>
              </div>
            </Link>
