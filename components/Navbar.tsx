        ...
        <div className="flex items-center justify-between gap-12">
          ...
          <div className="flex items-center gap-6 shrink-0 ml-auto xl:ml-0">
            ...
            <Link 
              ...
              className="flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5c] text-white px-5 py-3 rounded-2xl transition-all shadow-lg shadow-green-500/20 group hover:-translate-y-1 active:scale-95"
            >
